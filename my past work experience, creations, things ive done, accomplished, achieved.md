...
- CATEGORY: artistic (not thinking like a resume)
    - my personal website
    - Share Anything
    - Question Wiki
    - Hugz Project (just sending virtual hug). Then version where can send any symbol.
    - NoU
    - Currently
    - Notif/pingppl
    - all the different stories ive wrote
    - my various blogs
    - my various youtube channels
    - my two different Vibecamp apps
    - The game and map i made on Blackout
    - all the forge maps i made
    - all the trick jumps i discovered/created
    - all phone games i made
	    - Area51
	    - Star Shifter
	    - Spin Spun
    - all the unfinished Unity games i made
- CATEGORY: ideas
    - list of discovered symbols
    - list of mapped symbols
    - list of definitions
    - list of desires
    - list of "literally need help with"
    - Shmoji Universe challenges. Where i track your points totally myself. And i give you challenges
    - Profile builder. Build your profile for entire internet. iz about decoration. iz about having all your creations in one spot organized in your own way.
    - LifeOS: new way to traverse cyberspace using the symbolic system
* things i created
    ...
    * WEB FRONTENDS
        ...
        * Django frontends
        * SHTORIES: very small index file, css file, js file hosted on IPFS as a frontend to host NFT
    * BACKENDS
...
* things i edited, fixed
    ...
    * Angular frontend for ECRS webcart
* things i used
...
* CATEGORY: research-related
	* BeeMon Research Assistant for CS department at ASU
	* Made a quantum qbit with SSTEM team in our scholarship program.
